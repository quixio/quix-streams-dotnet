...
## IStreamTimeseriesProducer.AddDefinitions(List<ParameterDefinition>) Method
...
```csharp
void AddDefinitions(System.Collections.Generic.List<QuixStreams.Streaming.Models.ParameterDefinition> definitions);
```
#### Parameters

<a name='QuixStreams.Streaming.Models.StreamProducer.IStreamTimeseriesProducer.AddDefinitions(System.Collections.Generic.List_QuixStreams.Streaming.Models.ParameterDefinition_).definitions'></a>
